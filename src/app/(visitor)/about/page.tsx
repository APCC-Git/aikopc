...
export default function AboutPage() {
  return (
    <div className={'w-full p-4 md:p-10'}>
      ...
      {/* 活動環境セクション */}
      <section className="mb-12">
        <h2 className="mb-4 text-3xl font-bold">活動環境</h2>
        <div className="grid gap-6 md:grid-cols-3">
          <div className="dark:bg-card rounded-lg bg-slate-100 p-6">
            <h3 className="mb-2 text-xl font-bold">充実した機材</h3>
            <p>一人一台PCと開発環境を完備し、快適な開発作業が可能です。</p>
          </div>
          <div className="dark:bg-card rounded-lg bg-slate-100 p-6">
            <h3 className="mb-2 text-xl font-bold">技術サポート</h3>
            <p>先輩部員による丁寧な指導体制、プログラミング講座を整えています。</p>
          </div>
          <div className="dark:bg-card rounded-lg bg-slate-100 p-6">
            <h3 className="mb-2 text-xl font-bold">プロ ジェクト活動</h3>
      ...
      {/* 入部案内セクション */}
      <section>
        <h2 className="mb-4 text-3xl font-bold">入部案内</h2>
        <div className="dark:bg-card rounded-lg bg-slate-100 p-6">
