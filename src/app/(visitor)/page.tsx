  ...
  return (
    <div className={'w-full min-h-[calc(100vh-90px)] p-4 md:p-10 block md:flex'}>
      <div className={'mb-5 md:mr-10 xl:mr-20 p-4 text-center md:text-left'}>
        <div className={'text-6xl xl:text-8xl font-bold'}>Aikopc.net</div>
        <div className={'text-md xl:text-3xl mt-4'}>愛光学園パソコン部のホームページ</div>
        <div className={'mt-6 w-full flex justify-center md:justify-start'}>
          <Link href="/about">
            <Button className="inline-block xl:text-xl xl:h-12">活動について</Button>
          </Link>
          <Link href="/login">
            <Button variant="outline" className="inline-block ml-3 xl:text-xl xl:h-12">
              部員ログイン
            </Button>
          </Link>
        </div>
