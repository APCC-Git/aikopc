...
// --- Icons ---
import { AlignCenterIcon } from '@/components/dashboard/tiptap/tiptap-icons/align-center-icon';
import { AlignJustifyIcon } from '@/components/dashboard/tiptap/tiptap-icons/align-justify-icon';
import { AlignLeftIcon } from '@/components/dashboard/tiptap/tiptap-icons/align-left-icon';
import { AlignRightIcon } from '@/components/dashboard/tiptap/tiptap-icons/align-right-icon';
