...
// --- Icons ---
import { CornerDownLeftIcon } from '@/components/dashboard/tiptap/tiptap-icons/corner-down-left-icon';
import { ExternalLinkIcon } from '@/components/dashboard/tiptap/tiptap-icons/external-link-icon';
import { LinkIcon } from '@/components/dashboard/tiptap/tiptap-icons/link-icon';
import { TrashIcon } from '@/components/dashboard/tiptap/tiptap-icons/trash-icon';
...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from '@/components/dashboard/tiptap/tiptap-ui-primitive/popover';
import { Separator } from '@/components/dashboard/tiptap/tiptap-ui-primitive/separator';

// --- Styles ---
import '@/components/dashboard/tiptap/tiptap-ui/link-popover/link-popover.scss';
