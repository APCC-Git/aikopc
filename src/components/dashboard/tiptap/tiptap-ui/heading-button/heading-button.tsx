...
// --- Icons ---
import { HeadingOneIcon } from '@/components/dashboard/tiptap/tiptap-icons/heading-one-icon';
import { HeadingTwoIcon } from '@/components/dashboard/tiptap/tiptap-icons/heading-two-icon';
import { HeadingThreeIcon } from '@/components/dashboard/tiptap/tiptap-icons/heading-three-icon';
import { HeadingFourIcon } from '@/components/dashboard/tiptap/tiptap-icons/heading-four-icon';
import { HeadingFiveIcon } from '@/components/dashboard/tiptap/tiptap-icons/heading-five-icon';
import { HeadingSixIcon } from '@/components/dashboard/tiptap/tiptap-icons/heading-six-icon';
