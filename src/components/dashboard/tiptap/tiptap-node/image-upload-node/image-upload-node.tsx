...
import { CloseIcon } from '@/components/dashboard/tiptap/tiptap-icons/close-icon';
import '@/components/dashboard/tiptap/tiptap-node/image-upload-node/image-upload-node.scss';
