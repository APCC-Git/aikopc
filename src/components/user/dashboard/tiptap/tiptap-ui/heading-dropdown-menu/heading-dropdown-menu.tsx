...
// --- Icons ---
import { ChevronDownIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/chevron-down-icon';
import { HeadingIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-icon';
...
} from '@/components/user/dashboard/tiptap/tiptap-ui/heading-button/heading-button';
...
import {
  ...
  DropdownMenuItem,
  DropdownMenuGroup,
} from '@/components/user/dashboard/tiptap/tiptap-ui-primitive/dropdown-menu';
