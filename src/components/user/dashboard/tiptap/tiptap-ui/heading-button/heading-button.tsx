...
// --- Icons ---
import { HeadingOneIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-one-icon';
import { HeadingTwoIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-two-icon';
import { HeadingThreeIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-three-icon';
import { HeadingFourIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-four-icon';
import { HeadingFiveIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-five-icon';
import { HeadingSixIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/heading-six-icon';
