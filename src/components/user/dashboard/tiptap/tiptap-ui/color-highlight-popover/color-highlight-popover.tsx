...
// --- Icons ---
import { BanIcon } from '@/components/user/dashboard/tiptap/tiptap-icons/ban-icon';
...
import {
  ...
  canToggleHighlight,
} from '@/components/user/dashboard/tiptap/tiptap-ui/color-highlight-button';

// --- Styles ---
import '@/components/user/dashboard/tiptap/tiptap-ui/color-highlight-popover/color-highlight-popover.scss';
