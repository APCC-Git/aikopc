...
import {
  ...
  TooltipContent,
  TooltipTrigger,
} from '@/components/user/dashboard/tiptap/tiptap-ui-primitive/tooltip';

import '@/components/user/dashboard/tiptap/tiptap-ui-primitive/button/button-colors.scss';
import '@/components/user/dashboard/tiptap/tiptap-ui-primitive/button/button-group.scss';
import '@/components/user/dashboard/tiptap/tiptap-ui-primitive/button/button.scss';
